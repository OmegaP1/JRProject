  ...
  <React.StrictMode>
    <div class="justify-self-center">
      ...
      <div class="grid grid-cols-3 gap-10 ml-52 mr-52 mb-32">
        <div class="h-full hover:animate-spin-slow"><img src="images/Lisboa.svg"></img></div>
        <div class="h-full hover:animate-spin-slow"><img src="images/Londres.svg"></img></div>
        <div class="h-full hover:animate-spin-slow"><img src="images/SaoFrancisco.svg"></img></div>
      </div>
